...
PerfilesPNG(DatosConfirmados, "assets/img/confirmados/actuales/")
Mapa=MapaDeContagios(ConfirmadosOGR, "assets/img/confirmados/actuales/")
saveWidget(Mapa, file = "MapaConfirmados.html", selfcontained = F, title="Contagios confirmados")


ContagiosCPrediccion=ConfirmadosOGR
