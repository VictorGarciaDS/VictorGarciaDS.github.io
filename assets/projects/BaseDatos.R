...
MiPaleta<-function(Valores)
{
  ...
  Colores=rainbow(1530*Escalado)[(569*Escalado):(290*Escalado)]
  Colores=c(Colores, rainbow(1530*Escalado)[(290*Escalado):(236*Escalado)])
  Colores=c(Colores, rainbow(1530*Escalado)[(236*Escalado):1])
  #Se corta
...
#Aquí debo crear la paleta
sequence<-c(0,100,1000,10000,FocoRojo)
Paleta=MiPaleta(Contagios@data[,n])
...
MapaDeContagios<-function(Shape)
{
...
Mapa=MapaDeContagios(Contagios)
...
saveWidget(Mapa3, file = "index.html", selfcontained = F)
