...
\header
	...
	{\raisebox{-2ex}{\begin{minipage}{\textwidth \normalsize}
		...
		\hspace{-0.8cm}\begin{tabular}{l r}
					\textbf{MACHINE LEARNING}&\textbf{MODELING}\\
					\textbf{MATEMATICAL FINANCES}&\textbf{SAMPLING}
		\end{tabular}
	\end{tabular}
\end{minipage}}
}{}
...
\begin{entrylist}
    ...
    {\vspace{-1.4cm}}
    { }
    {\textbf{Speaker} at the Student Seminar of the Centro de Investigación en Matemáticas.}
    \entry
     {   \begin{tabular}{l}
    		\hspace{0.9cm}2019\\
